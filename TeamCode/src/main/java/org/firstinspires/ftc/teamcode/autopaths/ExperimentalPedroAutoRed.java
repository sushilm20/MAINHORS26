...
/**
 * ExperimentalPedroAutoRed — Red-side autonomous that mirrors ExperimentalPedroAuto but uses the
 ...
 */
@Autonomous(name = "No turn Experiment Auto - Red", group = "Autonomous",preselectTeleOp = "???HORS???")
@Configurable
public class ExperimentalPedroAutoRed extends OpMode {
    ...
    public ExperimentalPedroAutoRed() {}
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            Path1 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(124.000, 122.000), new Pose(96.000, 96.000))
                    )
            ...
            Path7 = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(121.000, 57.000), new Pose(114.000, 62.000))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .addPath(
                            new BezierLine(new Pose(114.000, 62.000), new Pose(96.000, 96.000))
                    )
                    .setConstantHeadingInterpolation(Math.toRadians(0))
                    .build();
