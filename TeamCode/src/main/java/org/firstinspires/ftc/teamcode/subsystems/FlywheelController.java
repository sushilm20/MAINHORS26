...
public class FlywheelController {
    ...
    @Sorter(sort = 5) public static double CLOSE_kD = 0.00001;
    ...
    @Sorter(sort = 14) public static double FAR_kP = 0.00300;//increased from 0.00222
    @Sorter(sort = 15) public static double FAR_kI = 0.0064;
    ...
    @Sorter(sort = 21) public static double FAR_powerSmoothingAlpha = 0.55555;
    ...
    // --- Target RPM presets ---
    @Sorter(sort = 25) public static double closeRPM = 2360;
    @Sorter(sort = 26) public static double farRPM = 3100;


    @Sorter(sort = 31) public static double rpmTolerance = 50.00;
